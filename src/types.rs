...
pub const BISHOP_MAGICS: [Magic; 64] = init_magics(BISHOP_MAGIC_NUMBERS, BISHOP_DIRS, 0);
...
pub const ROOK_MAGICS: [Magic; 64] = init_magics(ROOK_MAGIC_NUMBERS, ROOK_DIRS, 5248);
